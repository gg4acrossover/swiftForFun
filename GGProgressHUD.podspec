...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
  Simple Hub, wrapper with NVActivityIndicatorView. Enjoy
                       DESC

  s.homepage         = 'https://github.com/gg4acrossover/swiftForFun.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'gg4acrossover@gmail.com' => 'gg4acrossover@gmail.com' }
  s.source           = { :git => 'https://github.com/gg4acrossover/swiftForFun.git', :tag => s.version.to_s }
